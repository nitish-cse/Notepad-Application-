...
class Texteditor extends Frame implements ActionListener {
    ...
    //adding features in the file menu 
    CheckboxMenuItem chkb1= new CheckboxMenuItem("Word Wrap");
    CheckboxMenuItem chkb11 = new CheckboxMenuItem("Change font");
    //adding features in the file menu
    CheckboxMenuItem chkb2 = new CheckboxMenuItem("New file");
    CheckboxMenuItem chkb3 = new CheckboxMenuItem("Open file");
    CheckboxMenuItem chkb4 = new CheckboxMenuItem("Save File");
    CheckboxMenuItem chkb5 = new CheckboxMenuItem("Delete file");
